...
<div className="flex items-center justify-between mt-8 ml-14 mr-14">
  ...
  <span className="relative">Delivered</span>
        ...
        <td className="col-span-3">Introduction to web...</td>
        <td className="col-span-3" >
        <span className="relative inline-flex items-center px-3 py-1 font-semibold text-[#B5850B] leading-tight">
  <span aria-hidden className="absolute inset-0 bg-[#FFF6E9] opacity-50 rounded-full"></span>
  <img src={time} className="w-4 h-4 mr-2" alt="check" />
  <span className="relative">Pending</span>
        ...
        <td className="col-span-3">Introduction to web...</td>
        <td className="col-span-3" >
        <span className="relative inline-flex items-center px-3 py-1 font-semibold text-[#B83131] leading-tight">
  <span aria-hidden className="absolute inset-0 bg-[#FFEAEA] opacity-50 rounded-full"></span>
  <img src={cercle} className="w-4 h-4 mr-2" alt="check" />
